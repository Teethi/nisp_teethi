...
<head>
	...
	<title>IIC | Admin Dashboard</title>
...
<?php 
$sql ="SELECT Rid from participants ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql2 ="SELECT Rid FROM `participants` WHERE ieee_id!='' and wie_member=1 ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">WIE-IEEE Members</div>
												</div>
											</div>
											<a href="reg-users1.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
