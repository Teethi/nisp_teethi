...
<head>
	...
	<title>IIC |Admin Manage WIE-IEEE Members   </title>
...
<?php 
$sql = "SELECT * FROM `participants` WHERE ieee_id!='' and wie_member=1  ";
...
?>	
										<tr>
											...
											<td><?php echo htmlentities($result->ieee_id);?></td>
...
<!--
											<td><?php if( htmlentities($result->wie_member))
															echo "<i class='fa fa-check' style='color:green'></i>";
													   else
													   		echo "<i class='fa fa-close' style='color:red'></i>";

											//echo htmlentities($result->Class_Name);
